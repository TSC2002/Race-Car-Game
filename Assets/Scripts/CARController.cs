...
public class CARController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (EstoyFrenando)
        {
            RuedaIzquierdaDelantera.brakeTorque = 500.0f;
            RuedaDerechaDelantera.brakeTorque = 500.0f;
            RuedaIzquierdaTrasera.brakeTorque = 500.0f;
            RuedaDerechaTrasera.brakeTorque = 500.0f;
        }
        else
        {
